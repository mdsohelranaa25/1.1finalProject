...
public class ExamScheduleFrame extends JFrame {
    private Map<String, String> userInfo;
    private Color primaryColor = new Color(241, 196, 15);
    
    public ExamScheduleFrame(Map<String, String> userInfo) {
        this.userInfo = userInfo;
        setupFrame("📝 EXAM SCHEDULE");
        
        String[][] options = {
            {"📅", "Upcoming Exams", "View exam schedule"},
            {"📊", "Exam Results", "Check your results"},
            {"🎫", "Admit Card", "Download admit card"},
            {"📝", "Mid-term Exams", "Mid semester exams"},
            {"📖", "Final Exams", "Final semester exams"},
            {"📈", "Grade Report", "View grade sheet"}
        };
        
        Color[] colors = {
            new Color(241, 196, 15), new Color(52, 152, 219),
