...
public class ProfileFrame extends JFrame {
    ...
    private Color primaryColor = new Color(230, 126, 34);
    
    public ProfileFrame(Map<String, String> userInfo) {
        this.userInfo = userInfo;
        setupFrame("👤 PROFILE MANAGEMENT");
        
        String[][] options = {
            {"👤", "View Profile", "View your information"},
