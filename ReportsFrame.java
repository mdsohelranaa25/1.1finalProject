...
public class ReportsFrame extends JFrame {
    ...
    public ReportsFrame(Map<String, String> userInfo) {
        this.userInfo = userInfo;
        setupFrame("📊 REPORTS");
        
        String[][] options = {
            {"📊", "Attendance Report", "Generate attendance report"},
            {"📈", "Performance Report", "Academic performance"},
            {"📝", "Exam Report", "Exam results summary"},
            {"📅", "Monthly Report", "Month-wise analysis"},
            {"📄", "Transcript", "Academic transcript"},
            {"💾", "Download Reports", "Export to PDF/Excel"}
        };
        
        Color[] colors = {
            new Color(26, 188, 156), new Color(52, 152, 219),
