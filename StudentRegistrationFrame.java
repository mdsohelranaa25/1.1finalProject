...
public class StudentRegistrationFrame extends JFrame {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel subtitleLabel = new JLabel("Join our academic community");
    ...
    private JPanel createFormPanel() {
        ...
        // Batch
        addFormField(formPanel, "📅 Batch Year:", batchField = new JTextField(20), gbc, 3);
    ...
    private void handleRegistration() {
        ...
        // Validation
        if (name.isEmpty() || username.isEmpty() || password.isEmpty() || batch.isEmpty()) {
