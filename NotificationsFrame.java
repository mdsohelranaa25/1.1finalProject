...
public class NotificationsFrame extends JFrame {
    ...
    public NotificationsFrame(Map<String, String> userInfo) {
        this.userInfo = userInfo;
        setupFrame("🔔 NOTIFICATIONS");
        
        String[][] options = {
            {"🔔", "All Notifications", "View all alerts"},
            {"📅", "Schedule Changes", "Routine updates"},
            {"✅", "Attendance Alerts", "Low attendance warnings"},
            {"📝", "Exam Notices", "Exam announcements"},
            {"📚", "Course Updates", "Course information"},
