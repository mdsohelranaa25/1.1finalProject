...
public class CourseManagementFrame extends JFrame {
    ...
    public CourseManagementFrame(Map<String, String> userInfo) {
        this.userInfo = userInfo;
        setupFrame("📚 COURSE MANAGEMENT");
        
        String[][] options = {
            {"📖", "My Courses", "View enrolled courses"},
            {"➕", "Enroll Course", "Add new course"},
            {"📋", "Course Details", "View course information"},
            {"📚", "Course Materials", "Access study materials"},
            {"👨‍🏫", "Teacher Info", "View teacher details"},
            {"⭐", "Course Rating", "Rate your courses"}
        };
